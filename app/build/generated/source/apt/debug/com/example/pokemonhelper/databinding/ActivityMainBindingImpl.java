...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.margin, 1);
        sViewsWithIds.put(R.id.txtTitle, 2);
        sViewsWithIds.put(R.id.choice, 3);
        sViewsWithIds.put(R.id.marginM, 4);
        sViewsWithIds.put(R.id.login, 5);
        sViewsWithIds.put(R.id.marginMid, 6);
        sViewsWithIds.put(R.id.reg, 7);
    }
    // views
    @NonNull
